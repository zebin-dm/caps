...
class EfficientUNet(nn.Module):
    def __init__(self, encoder='b0', pretrained=True, coarse_out_ch=128, fine_out_ch=128):
        ...
        self.upconv2 = upconv(filters[1], 40, 3, 2)
        self.iconv2 = conv(40, 40, 3, 1)
        # fine-level conv
        self.conv_fine = conv(40, fine_out_ch, 3, 1)

        # s4_branch_cfg = efficientnet.MBConvConfig(6, 3, 1, 24, 24, 2, width_mult=1.0, depth_mult=1.0)
        # self.s4_branch = efficientnet.MBConv(cnf=s4_branch_cfg,
        #                                      stochastic_depth_prob=0.2,
        #                                      norm_layer=nn.BatchNorm2d)

        initialize_weights(self)
        
        # self.s4_branch = efficient_ins.features[1]
...
def to_onnx():
    ...
    onnx_model_path = "./dm_superpointv3_2.onnx"
